...
- generic [active] [ref=e1]:
  ...
  - contentinfo [ref=e74]:
    ...
    - generic [ref=e91]:
      - button "Privacy and cookie settings" [ref=e92] [cursor=pointer]
      - generic [ref=e93]: "Managed by Google. Complies with IAB TCF. CMP ID: 300"
  - text: 
```